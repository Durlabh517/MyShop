...
<div>
	...
	<table width="820" bgcolor="#66CCCC" align="center">
	<tr align="center" >
	...
	<tr></tr>
		...
		<td ><input type="text" name="c_email" /></td></tr>
		
		<tr><td align="right"><b>Your Password:</b></td>
	...
	<?php if (isset($_GET['forgot_pass'])) {
		...
		echo "<form action='' method='post'><div align='center'>
		<b>Enter your email below,we'll send your password to your email</b><br>
		<input type='text' name='c_email' placeholder='Enter Your Email' required='required'><b>
		<input type='submit' name='forgot_pass' value='Send '>
...
<h3>Thank you for using our website</h3>
			...
			?>
	<a href="customer_register.php"><h2 style="float: right;padding: 10px;">New Register Here </h2></a>
